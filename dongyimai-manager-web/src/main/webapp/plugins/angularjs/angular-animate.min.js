        ...
        D.register("", ["$window", "$sniffer", "$timeout", "$$animateReflow", function (n, l, D, I) {
            ...
            function L(a, e, y) {
                ...
                if (-1 != h.className.indexOf(e) && m) {
                    var k = m.timings, l = m.stagger, n = m.maxDuration, r = m.activeClassName,
            ...
            var $ = "Duration", X = "Property", F = "Delay", S = "IterationCount", z = "$$ngAnimateKey",
                q = "$$ngAnimateCSS3Data", A = 3, v = 1.5, aa = 1E3, B = 0, w = {}, Z = 0, V = [], W = [], P, Q = 0;
            return {
